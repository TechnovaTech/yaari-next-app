...
export function SocketProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const socketUrl = process.env.NEXT_PUBLIC_SOCKET_URL || (typeof window !== 'undefined' && window.location.hostname === 'localhost' ? 'https://admin.yaari.me' : 'https://admin.yaari.me')
